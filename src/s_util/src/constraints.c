...
#if !IS_VALID_AREA(FOS_SHARED_AREA_START, FOS_SHARED_AREA_END)
#pragma message("SHARED_AREA (Start: " STRINGIFY(FOS_SHARED_AREA_START) ", END: " STRINGIFY(FOS_SHARED_AREA_END) ")")
#error "SHARED_AREA is invalid!"
#endif
...
#if FOS_FREE_AREA_END > FOS_SHARED_AREA_START
#error "FREE_AREA overlaps SHARED_AREA!"
#endif

#if FOS_SHARED_AREA_END > FOS_STACK_AREA_START
#error "SHARED_AREA overlaps STACK_AREA!"
#endif
