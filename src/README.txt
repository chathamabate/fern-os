...
Memory Image Notes:
 ...
 [ Preface Area   ]     (4MB Aligned) Reserved for BIOS Stuff.
 [ RO Data + Code ]     ALL code and read only data.
 ...
 [ ......         ]     ^^
 [ Stack          ]     Grows Down 
 [ Reserved Area  ]     (4MB Aligned) Unusable Area!
...
data. A user thread will never be able to directly access the kernel data, and the kernel thread 
will never be able to directly access the user data of a user process. To make more processes the
intial user process must fork.
